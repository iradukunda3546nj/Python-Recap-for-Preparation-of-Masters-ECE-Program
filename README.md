...
Secondly, The # is used for in-line documentation for improving codes readability and also the identation is very important at the beginning of the code especially when you want to show the blocks of the code or of given function or a class.

* Python uses direct-initialization method for variables , that i to say that the variables are only declared or created once they are assigned the values.

* what is a cumputer program ? , basically, a computer program is defined as a set of instructions to be excuted by the computer.

* in Programming, computer instructions are commonly known as "statements"
* varibales are considerd to be like containers for storing data.
* Unlike other programming languages,in Python, the vairable is created once you assign the value to it.
